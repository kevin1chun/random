		    ...
		    int len)
{
   ...
   * short paragraph 
    ...
    This function scans sections of the array, then
    passes off the meta array (ie the array comprised of the
    last values of the individual scans), off to an update 
    function, which adds the prior section's scan value to
    each section. 
    */
...
int main(int argc, char *argv[])
{
  ...
  if (fail == 0) 
    printf("Correct! CPU:%g vs GPU:%g => %gX\n",t1, tG, t1/tG);
